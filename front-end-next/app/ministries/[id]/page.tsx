...
export default async function MinistryBlogsPage({ params }: { params: { id: string } }) {
  const blogs = await fetchPublicResource<Blog[]>(`blogs?ministry_id=${encodeURIComponent(params.id)}`).catch(() => []);
  const title = blogs[0]?.ministry_name ? `${blogs[0].ministry_name} Ministry` : "Ministry Blogs";
        ...
        <div className="container">
          <div className="page-heading">
            ...
            <ul className="breadcrumb-items wow fadeInUp" data-wow-delay=".5s">
              ...
              <li><a href="/blogs">Ministries</a></li>
              <li><i className="fa-solid fa-chevron-right" /></li>
